...
export default function HomePage() {
  ...
  // Slide change every 2.5 seconds
  useEffect(() => {
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            {!user && (
              <>
                <Link
                  href="/signup"
                  className="px-6 py-3 bg-purple-600 text-white rounded-full shadow-lg hover:bg-purple-700 transition duration-300"
                >
                  Get Started
                </Link>
                <Link
                  href="/login"
                  className="px-6 py-3 bg-white text-purple-600 border border-purple-600 rounded-full shadow hover:bg-white/80 transition duration-300"
                >
                  Login
                </Link>
              </>
